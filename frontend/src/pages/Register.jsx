...
import { User, Stethoscope, Lock, Mail, CreditCard, Activity } from 'lucide-react';
          ...
          <div className="flex bg-slate-100 p-1 rounded-lg">
            <button
              ...
              className={`flex-1 py-2 text-sm font-medium rounded-md transition-all ${
                formData.role === 'patient' ? 'bg-white text-primary shadow-sm' : 'text-slate-500 hover:text-slate-700'
              }`}
            >
              Patient
            </button>
            <button
              ...
              className={`flex-1 py-2 text-sm font-medium rounded-md transition-all ${
                formData.role === 'doctor' ? 'bg-white text-primary shadow-sm' : 'text-slate-500 hover:text-slate-700'
              }`}
            >
              Doctor
            </button>
